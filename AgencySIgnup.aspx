    <%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgencySignUp.aspx.cs" Inherits="AgencySignUp" %>
...
<body>
    <form id="form1" runat="server">
        <div class="card">
            <h2 class="text-center">Agency Sign Up</h2>
            <asp:Label ID="lblMessage" runat="server" CssClass="text-danger"></asp:Label>

            <div class="form-group">
                <asp:Label ID="lblAgencyName" runat="server" Text="Agency Name:" CssClass="form-label"></asp:Label>
                ...
                <asp:RequiredFieldValidator ID="rfvAgencyName" runat="server" ControlToValidate="txtAgencyName" 
                    ErrorMessage="Agency Name is required." CssClass="text-danger" Display="Dynamic"></asp:RequiredFieldValidator>
            </div>
